...
public class TuBaMallUserController {
    @Resource
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(tuBaMallUserService.getTuBaMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (tuBaMallUserService.lockUsers(ids, lockStatus)) {
