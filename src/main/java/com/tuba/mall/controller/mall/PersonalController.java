...
public class PersonalController {
    @Resource
    private TuBaMallUserService tuBaMallUserService;
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        String loginResult = tuBaMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        String registerResult = tuBaMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        TuBaMallUserVO mallUserTemp = tuBaMallUserService.updateUserInfo(mallUser, httpSession);
